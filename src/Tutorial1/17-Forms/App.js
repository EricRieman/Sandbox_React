        ...
        return(
            <div>
                <form onSubmit={this.handleSubmit}>
                    ...
                    {
                        // in html5, if a button is defined inside a form, it acts the same as 
                        // the input type submit: <input type="submit"> element. it is generally
                        // better to not use the input type submit, and instead use a button inside
                        // a form. Both will fire the onSubmit event.

                        // we could use the onClick of a button to tie into the submit or, becasue we 
                        // are trigging the onSubmit, we can use the parent forms' onSubmit
                    }
